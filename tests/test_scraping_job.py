...
def test_scraping_job_max_pages():
    ...
    job = ScrapingJob(name="test_max", seed_urls=["https://example.com"], max_pages=2)
...
def test_scraping_job_domain_restriction():
    ...
    job = ScrapingJob(
        name="test_domain", seed_urls=["https://example.com"], domain_restricted=True
    )
...
def test_scraping_job_depth_limit():
    ...
    job = ScrapingJob(name="test_depth", seed_urls=["https://example.com"], max_depth=2)
...
def test_scraping_job_statistics():
    ...
    job = ScrapingJob(name="test_stats", seed_urls=["https://example.com"])
